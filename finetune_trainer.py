...
class Trainer(object):
    ...
    def train_for_binaryclass(self):
        ...
        return dict(best_epoch=best_f1_epoch, best_val_auroc=float(roc_auc_best),
                    balanced_accuracy=float(acc), pr_auc=float(pr_auc), auroc=float(roc_auc),
                    confusion_matrix=cm.tolist(), checkpoint=model_path)
